...
if(isset($_POST['order_update'])){ //check if form was submitted
	...
	if (mysqli_query($conn, $updateord_query) && mysqli_query($conn, $updateordref_query)) {
		$message = "<p style='color:green'>Record updated successfully</p>";
	  } else {
		$message = "<p style='color:green'>Error updating record: </p>" . mysqli_error($conn);
	  }
}
...
<body>
	...
	<?php
		...
		if(isset($_POST['submit'])){ //check if form was submitted
			...
			$runord_query = mysqli_query($conn, $orders_query);
			$runordref_query = mysqli_query($conn, $orderref_query);
			$p_id='';
