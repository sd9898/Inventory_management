...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>Inventory Management System-ContactUs</title>
...
<body>
    ...
    <div id="ContactUs" class="w3-container">
      ...
      <h2 style="margin-left: 50px"> ims(DBMS)@gmail.com</h2>
      <br>
      <br>
      <br>
      <h1 class="w3-text-teal">Call Us at:-</h1>
      <h2 class="w3-text-white" style="margin-left: 50px"> +91 9898989898</h2>
